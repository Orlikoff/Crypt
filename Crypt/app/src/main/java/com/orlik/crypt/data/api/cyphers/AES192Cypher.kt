...
class AES192Cypher: CypherRequest {
    override fun getResultFromServer(data: String, mode: Boolean, context: Context): String {
        ...
        val tempRequest = if (mode)
            Request.Builder().url("https://encrypt-decrypt-hash.p.rapidapi.com/aes192/decrypt") else
            Request.Builder().url("https://encrypt-decrypt-hash.p.rapidapi.com/aes192/encrypt")
